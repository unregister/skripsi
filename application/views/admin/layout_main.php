...
<head>
    ...
    <link href="<?php echo admin_template_url();?>css/bootstrap.css" rel="stylesheet">
    <link href="<?php echo admin_template_url();?>css/font-awesome.css" rel="stylesheet">
    <link href="<?php echo admin_template_url();?>css/admin.css" rel="stylesheet">
    <link href="<?php echo admin_template_url();?>js/datepicker/jquery.datepick.css" rel="stylesheet">
    <script src="<?php echo admin_template_url();?>js/jquery.js"></script>
...
<div style="display: none;">
	<img id="calImg" src="<?php echo admin_template_url();?>js/datepicker/calendar-green.gif" alt="Popup" class="trigger">
</div>
		...
		<ul class="nav nav-pills pull-right">
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
                    <li><a href="<?php echo site_url('admin/user/password');?>">Ubah password</a></li>
                    <li class="divider"></li>
