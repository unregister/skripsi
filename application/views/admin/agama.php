...
?>
	<tr>
        ...
        <td class="actions">
            <a class="btn btn-small btn-danger" href="<?php echo site_url('admin/agama/delete/'.$agm['id_agama']);?>" href="#removeItem" onclick="<?php echo confirm('Yakin mau hapus data ini?');?>">Hapus</a>
