<div class="slate">
   ...
   <?php show_message();?>
    ...
    <?php echo form_open( site_url('admin/group/edit/'.$result['id_group']), array('class' => 'form-horizontal') );?>
    <fieldset>
      <div class="control-group">
        <label for="focusedInput" class="control-label">Nama Group</label>
        <div class="controls">
        <?php 
			$nama = array('name' => 'nama', 'class' => 'input-xlarge focused','id' => 'focusedInput','value' => $result['nama_group']);
